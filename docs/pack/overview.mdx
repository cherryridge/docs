...
- Lua, via [Luau](https://luau-lang.org).
...
A content pack must have a `manifest.json` file in its root directory, which describes the metadata of the content pack.
