...
- WebAssembly, via [Wasmer](https://wasmer.io), which can be compiled from many languages like C, C++, and Rust. It's the preferred and most efficient way to create a serious pack.
...
block-beta
    ...
    nlohmann_json V8 Wasmer LuaJIT
